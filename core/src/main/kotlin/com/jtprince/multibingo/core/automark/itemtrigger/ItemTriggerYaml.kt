...
import com.jtprince.multibingo.core.automark.MissingVariableException
import com.jtprince.multibingo.core.automark.TriggerDefinition
...
class ItemTriggerYaml private constructor(
    ...
    internal class Variable(yamlVarValue: String?, defaultConstant: Int) {
        ...
        fun getSetVariable(setVariables: Map<String, Int>): Int {
