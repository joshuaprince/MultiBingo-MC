 ...
 *
 * No Minecraft player will ever exist for this player on this instance. This class can only be
 * used for referencing a remote player (such as printing messages when a space is marked by
 * someone externally).
 */
