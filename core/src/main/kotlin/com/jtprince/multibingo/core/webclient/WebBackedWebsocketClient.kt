...
) : WebSocketClient(urlFormatter.websocketUrl(gameCode, clientId)) {
    private val logger = Logger.getLogger("multibingo.core.websocket")
...
//    private var reconnectTask: BingoScheduler.Task? = null
